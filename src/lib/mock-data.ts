...
export const mockAccounts: AccountVM[] = [
  ...
  // ---------------------------------------------------------------------
  // Prospects P1-1 — pas encore clients, présents dans le Pipeline &
  // Opportunités (module P1-1) mais sans historique Score de risque/tickets.
  // ---------------------------------------------------------------------
  {
    id: "acc_partenaire_prospect_1",
    segment: "PARTENAIRE",
    nom: "Yoga Loft Almadies",
    niveauAccompagnement: "LOW_TOUCH",
    phaseLifecycle: "ONBOARDING",
    csmAssigne: "Marieme Mbaye",
    dateCreation: "2026-07-01",
    contacts: [
      { id: "c_4", prenom: "Aïda", nom: "Fall", role: "Gérante", estContactPrincipal: true, telephone: "+221 77 555 12 34" },
    ],
    partenaireProfile: {
      typeActivite: "STUDIO",
      ville: "Dakar",
      adresse: "Almadies, Dakar",
      statutProfilCompletudePct: 10,
      reservationsRecuesTotal: 0,
    },
    interactions: [],
    risqueScoreHistorique: [],
    momentsDeVerite: [],
  ...
  {
    id: "acc_partenaire_prospect_2",
    segment: "PARTENAIRE",
    nom: "Coach Aminata Sy",
    niveauAccompagnement: "LOW_TOUCH",
    phaseLifecycle: "ONBOARDING",
    csmAssigne: "Marieme Mbaye",
  ...
  {
    id: "acc_partenaire_prospect_4",
    segment: "PARTENAIRE",
    nom: "Spa Teranga Wellness",
    niveauAccompagnement: "HIGH_TOUCH",
    phaseLifecycle: "ONBOARDING",
    csmAssigne: "Marieme Mbaye",
    dateCreation: "2026-05-28",
    contacts: [
      { id: "c_5", prenom: "Khady", nom: "Diouf", role: "Directrice", estContactPrincipal: true },
    ],
    partenaireProfile: {
      typeActivite: "ESPACE_BIEN_ETRE",
      ville: "Dakar",
      statutProfilCompletudePct: 55,
      reservationsRecuesTotal: 0,
    },
    interactions: [],
    risqueScoreHistorique: [],
  ...
  {
    id: "acc_partenaire_ambassadeur_1",
    segment: "PARTENAIRE",
    nom: "Studio Pilates Sacré-Cœur",
    niveauAccompagnement: "HIGH_TOUCH",
    phaseLifecycle: "EXPANSION",
    risqueScoreActuel: 91,
    risqueScoreStatut: "VERT",
    csmAssigne: "Marieme Mbaye",
    ...
    partenaireProfile: {
      ...
      statutProfilCompletudePct: 100,
      tauxRemplissageMoyenPct: 88,
      reservationsRecuesTotal: 1240,
      satisfactionScore: 9,
      dateSignature: "2025-08-10",
    },
    interactions: [],
    risqueScoreHistorique: [
      { id: "hs_13", score: 91, statut: "VERT", dateCalcul: "2026-07-01", detailCriteres: [] },
    ],
    momentsDeVerite: [],
    playbookExecutions: [],
  },
  {
    id: "acc_entreprise_prospect_1",
    segment: "ENTREPRISE_QVT",
    ...
    contacts: [
      { id: "c_6", prenom: "Moussa", nom: "Kane", role: "Interlocuteur RH", estContactPrincipal: true },
    ],
    entrepriseQvtProfile: {
  ...
  },
  {
    ...
    contacts: [
      { id: "c_7", prenom: "Aïcha", nom: "Ndoye", role: "Interlocuteur RH", estContactPrincipal: true },
    ],
    entrepriseQvtProfile: {
